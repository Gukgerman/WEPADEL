...
export const about = {
  ...
  lead: "WE are PADEL (I - ПАДЕЛ) - це відкритий падел-клуб.",
  ...
  features: [
    ...
    {
      number: "03",
      title: "Професійні карти",
      desc: "Високоякісне покриття, передове обладнання та освітлення. Продумана інфраструктура для матчів",
      variant: "dark",
    },
    {
      number: "04",
