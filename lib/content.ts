...
export const pricing = {
  ...
  basic: {
    ...
    modal: {
      title: "Базовий",
      heading: "Що включено до тарифу:",
      items: [
        "До 4 гравців",
        "Ракетки та м'ячі для гри",
        "Відкритий корт",
        "Зона відпочинку та роздягальні",
        "Бронювання за попереднім записом",
      ],
      cta: "залишити заявку",
    },
  },
